...
<div align="center">
  ...
  <br/>
<h1 align="center">Rails-recipe-app</h1>
</div>
...
**Recipe-app** is a simple application or platform that allows users to store, organize, and share recipes. It typically provides features and functionalities to assist users in managing their recipe collections, built with ROR (ruby with rails)
...
```sh
  cd my-folder
  git clone git@github.com:matee-safi/Rails-recipe-app.git
...
Feel free to check the [issues page](https://github.com/matee-safi/Rails-recipe-app/issues).
