...
```
git clone git@github.com:waelelsafty07/RecipeApp.git
```
Using HTTPS:

```
git clone https://github.com/waelelsafty07/RecipeApp.git
```
...
Feel free to check the [issues page](https://github.com/waelelsafty07/RecipeApp/issues).
...
If you encounter any issues or have any questions or suggestions, please open an issue on the [issue tracker](https://github.com/waelelsafty07/RecipeApp/issues).
