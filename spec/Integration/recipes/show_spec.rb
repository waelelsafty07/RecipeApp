...
RSpec.describe 'food new view page', type: :system do
  ...
  let!(:recipe2) do
    Recipe.create(user_id: user1.id, name: 'Recipe 2', preparation_time: '2', cooking_time: 5, description: 'just testing',
                  public: true)
  end
  let!(:recipe3) do
    Recipe.create(user_id: user1.id, name: 'Recipe 3', preparation_time: '2', cooking_time: 5, description: 'just testing',
                  public: true)
  end
